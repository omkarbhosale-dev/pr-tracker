...
function formatCommentMarkdown(analysis, pr) {
  ...
  // Add a "Bot" badge visually at the top
  const botBadge = `![Bot](https://img.shields.io/badge/🤖_AI_Assistant-Bot-blue?style=flat-square)`;
...
---
<sub>🤖 Auto Response from Bot · Model: \`${process.env.OPENROUTER_MODEL || "deepseek/deepseek-chat-v3-0324:free"}\`</sub>`;
}
